...
Another goal of *PathMaker* is to be able to generate a wide array of grids with varying complexities and to be able to compare algorithms based on grid complexity. Based on these plots of the data collected by PathMaker. It can be used to make comparisons between algorithms; however, the ability to generate grids of varying complexity is questionable, especially when looking at randomized grids, which are either of very low complexity or high complexity, and almost no grids were generated in between. 
